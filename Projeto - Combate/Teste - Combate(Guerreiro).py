...
def combate(inimigo1, inimigonome):
        ...
        if opcoes == 1:
            ...
            if controle == 1:
                ...
                if numtirado == 1 or numtirado == 2 or numtirado == 3:
                    ...
                    time.sleep(1)
                    numtirado = dado()
                    print(f'{inimigonome} jogou o dado para se defender!')
                    time.sleep(2)
                    print(f'Tirou o número {numtirado}')
                    time.sleep(2)
                    if numtirado == 1:
                        print(f'{inimigonome} se desviou do golpe!')
                    elif numtirado == 2:
                        print(f'{inimigonome} recebeu {atributos[1] * 0.20} de dano!!!')
                        inimigo1[0] -= atributos[1] * 0.20
                    elif numtirado == 3:
                        print(f'{inimigonome} recebeu {atributos[1] * 0.40} de dano!!!')
                        inimigo1[0] -= atributos[1] * 0.40
                    elif numtirado == 4:
                        print(f'{inimigonome} recebeu {atributos[1] * 0.60} de dano!!!')
                        inimigo1[0] -= atributos[1] * 0.60
                    elif numtirado == 5:
                        print(f'{inimigonome} recebeu {atributos[1] * 0.80} de dano!!!')
                        inimigo1[0] -= atributos[1] * 0.80
                    elif numtirado == 6:
                        print(f'{inimigonome} recebeu {atributos[1] * 1.00} de dano!!!')
                    ...
                    if atributosbatalha[2] < 40:
                        ...
                        if numtirado == 1:
                            ...
                            print(f'{inimigonome} recebeu {120 * 0.40} de dano!!!')
                            inimigo1[0] -= 120 * 0.40
                        elif numtirado == 3:
                            print(f'{inimigonome} recebeu {120 * 0.40} de dano!!!')
                            inimigo1[0] -= 120 * 0.40
                        elif numtirado == 4:
                            print(f'{inimigonome} recebeu {120 * 0.80} de dano!!!')
                            inimigo1[0] -= 120 * 0.80
                        elif numtirado == 5:
                            print(f'{inimigonome} recebeu {120 * 0.80} de dano!!!')
                            inimigo1[0] -= 120 * 0.80
                        elif numtirado == 6:
                            print(f'{inimigonome} recebeu {120 * 1.00} de dano!!!')
                            inimigo1[0] -= 120 * 1.00
                        time.sleep(2)
                elif numtirado == 5:
                    if atributosbatalha[2] < 60:
                        ...
                        if numtirado == 1:
                            ...
                            print(f'{inimigonome} recebeu {140 * 0.60} de dano!!!')
                            inimigo1[0] -= 140 * 0.60
                        elif numtirado == 3:
                            print(f'{inimigonome} recebeu {140 * 0.60} de dano!!!')
                            inimigo1[0] -= 140 * 0.60
                        elif numtirado == 4:
                            print(f'{inimigonome} recebeu {140 * 0.80} de dano!!!')
                            inimigo1[0] -= 140 * 0.80
                        elif numtirado == 5:
                            print(f'{inimigonome} recebeu {140 * 0.80} de dano!!!')
                            inimigo1[0] -= 140 * 0.80
                        elif numtirado == 6:
                            print(f'{inimigonome} recebeu {140 * 1.00} de dano!!!')
                            inimigo1[0] -= 140 * 1.00
                        time.sleep(2)
                elif numtirado == 6:
                    if atributosbatalha[2] < 80:
                        ...
                        if numtirado == 1:
                            ...
                            print(f'{inimigonome} recebeu {160 * 0.60} de dano!!!')
                            inimigo1[0] -= 160 * 0.60
                        elif numtirado == 3:
                            print(f'{inimigonome} recebeu {160 * 0.60} de dano!!!')
                            inimigo1[0] -= 160 * 0.60
                        elif numtirado == 4:
                            print(f'{inimigonome} recebeu {160 * 0.80} de dano!!!')
                            inimigo1[0] -= 160 * 0.80
                        elif numtirado == 5:
                            print(f'{inimigonome} recebeu {160 * 0.80} de dano!!!')
                            inimigo1[0] -= 160 * 0.80
                        elif numtirado == 6:
                            print(f'{inimigonome} recebeu {160 * 1.00} de dano!!!')
                            inimigo1[0] -= 160 * 1.00
                        time.sleep(2)
            elif controle == 2:
                continue
...
Escolha um de seus itens: '''))
        ...
        if inimigo1[0] > 0:
            print(f'\033[1;40;31mVez de {inimigonome}\033[m')
            time.sleep(1)
            numtirado = dado()
            print(f'{inimigonome} te atacou! Você jogou o dado para tentar se defender!')
            time.sleep(2)
            print(f'Você tirou o número {numtirado}')
            time.sleep(1)
            if numtirado == 1:
                print(f'{inimigonome} errou o golpe!')
            elif numtirado == 2:
    ...
    if inimigo1[0] <= 0:
        opcoes = int(input(f'''{'-' * 62}
                  \033[0;32mParabéns você derrotou {inimigonome}!\033[m
...
combate(inimigo1=[400,90,780], inimigonome='Mascariane')