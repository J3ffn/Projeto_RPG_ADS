...
####################
p1 = Batalha()
p1.combate([2000, 500], 'Mascariane', 'off')
...
while fechar_jogo != "s":
    ...
    if class_e_atributos[0] == "Guerreiro":
        txt(f"""    Em um reino distante, conhecido como Mambla, foi acolhido um bebê recém-nascido, que 
    ...
    E assim sua ambição escolhida, e sua história começara a ser escrita...""", 0.06)
            ...
            if escolhas[1] == 1:
                ...
                if escolhas[2] == 1:
                    ...
                    if escolhas[3] == 1:
                        ...
                        dinheiro += 100
                        txt("Chegando lá, é recebido muito bem por ser de uma família bem falada.", 0.06)
                        escolhas.append(ver(input("Escolhas:\n"
                                                  "[1].Buscar pelo ítem.\n"
                        ...
                        if escolhas[5] == 1:
                            ...
                            if escolhas[6] == 1:
                                ...
                                txt("No caminho para a masmorra alguém com uma espada e uma coroa estava no caminho.",
                                    0.08)
                                txt("-'Parem, eu preciso desta Elfo!!'", 0.08)
                                time.sleep(0.4)
